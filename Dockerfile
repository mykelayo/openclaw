...
RUN --mount=type=cache,id=s/fb47bb41-5bdd-4ef4-94bc-1236d3cd0791-/root/.local/share/pnpm/store,target=/root/.local/share/pnpm/store,sharing=locked \
...
RUN --mount=type=cache,id=s/fb47bb41-5bdd-4ef4-94bc-1236d3cd0791-/var/cache/apt,target=/var/cache/apt,sharing=locked \
    --mount=type=cache,id=s/fb47bb41-5bdd-4ef4-94bc-1236d3cd0791-/var/lib/apt,target=/var/lib/apt,sharing=locked \
    apt-get update && \
